 ...
 * SPDX-FileCopyrightText: 2021 Bharat Kalluri <bharatkalluri@protonmail.com>
 */
...
namespace Splash {
    ...
    public class Application : Gtk.Application {
        ...
        public Application () {
            Object(
                application_id: "com.github.BharatKalluri.splash",
                flags: ApplicationFlags.FLAGS_NONE
            );

            saved_state = new GLib.Settings ("com.github.BharatKalluri.splash.saved-state");
            ...
            // on the --help screen.
            set_option_context_summary (_("Get high res backgrounds from unsplash!"));
            ...
            // on the --help screen.
            set_option_context_description (_("Copyright ⓒ 2021-present Bharat Kalluri. Licensed under GNU GPL version 3.0."));
